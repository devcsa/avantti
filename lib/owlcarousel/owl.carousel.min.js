!(function (t, e, i, s) {
      ...
      (n.prototype.to = function (t, e) {
         ...
         this.settings.loop
            ? (!this.settings.rewind && Math.abs(n) > r / 2 && (n += -1 * o * r),
              (s = (((((t = i + n) - a) % r) + r) % r) + a) !== t && s - n <= h && s - n > 0 && ((i = s - n), (t = s), this.reset(i)))
   ...
   (function (t) {
      function e(e, i) {
         ...
         return (
            t.each((e + " " + n.join(r + " ") + r).split(" "), function (t, e) {
               if (undefined !== s[e]) return (o = !i || e), !1;
            }),
            o
         );
      }
      ...
      (function () {
         return !!e("transition");
      })() && ((t.support.transition = new String(i("transition"))), (t.support.transition.end = o.transition.end[t.support.transition])),
         h() && ((t.support.animation = new String(i("animation"))), (t.support.animation.end = o.animation.end[t.support.animation])),
         r() && ((t.support.transform = new String(i("transform"))), (t.support.transform3d = a()));
   })(window.Zepto || window.jQuery, window, document);
