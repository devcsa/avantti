...
<head>
  ...
  <meta name="description"
    content="Explore as soluções complementares da Avantti Inovação para transformação digital e inovação. Oferecemos serviços adicionais que ampliam o impacto de nossos projetos, garantindo resultados consistentes e sustentáveis para sua empresa.">
...
<body>
      ...
      <div class="container-fluid bg-primary py-5 bg-header-conheca">
        <div class="row py-5">
          <div class="col-12 pt-lg-5 mt-lg-5 text-center">
            <h6 class="display-4 text-white animated zoomIn text-uppercase mb-4">Como funciona o <span
                class="text-primary">Avantt.i</span></h6>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="w-100 conheca bg-light shadow d-flex align-items-center justify-content-center p-3 mb-4">
    <p class="mt-3 text-center text-primary" style="max-width: 900px">
      Aqui você encontra <strong>nossos serviços</strong> adicionais, blog, tutoriais, materiais ricos.<br />
      Conheça um pouco mais sobre nosso propósito, nossa história e nossos valores.
      <br /><br />
      Separamos conteúdos relevantes para você <strong>gerir a inovação</strong> na sua empresa de forma <br />eficiente
      e direto ao ponto, sem complicações..
    </p>
  </div>

  <main class="principal w-100">
    <div class="container-fluid py-0 wow fadeInUp border-bottom" data-wow-delay="0.1s">
      <div class="container d-flex justify-content-center">
        <div class="container-services">
          <ul>
            <li class="c-services__item mb-3">
              <a href="index">
                <h3>Sobre nós</h3>
                <p>Conheça mais sobre o time por trás da Avantt.i e todo know-how aplicado cuidadosamente no
                  desenvolvimento
                  da plataforma.</p>
              </a>
            </li>
            <li class="c-services__item mb-3">
              <h3>Serviços</h3>
              <p>Acesse agora nossos adicionais como palestras, workshops, mentorias extras e muito mais para otimizar a
                sua experiência.</p>
            </li>
            <li class="c-services__item mb-3">
              <h3>Materiais</h3>
              <p>Tudo o que você precisa saber sobre inovação, frameworks e nossa caixa de ferramentas para descomplicar
                a inovação no seu negócio.</p>
            </li>
            <li class="c-services__item">
              <h3>Blog</h3>
              <p>Confira o blog Avantt.i e navegue por um conteúdo imersão sobre gestão da inovação, métricas, cultura
                de
                inovação, engajamento dos colaboradores e muito mais.</p>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="container-fluid wow fadeInUp" data-wow-delay="0.1s">
      <div class="container">
        <div class="row g-5">
          <div class="col-lg-12 pt-5 ciclo-more">
            <div class="position-relative">
              <img class="position-absolute rounded wow zoomIn w-100 gif-mobile" data-wow-delay="0.9s"
                src="./assets/img/ciclo.png" alt="Imagem Ciclo" />
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="w-100 container d-flex pb-5 align-items-center justify-content-center border-bottom mt-5">
      <button type="button" class="btn btn-primary py-md-3 px-md-4 mb-4 animated slideInLeft textos-btn-mobile"
        data-bs-toggle="modal" data-bs-target="#searchModal">
        Comece a inovar com a Avantt.i
      </button>
    </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content" style="background: rgba(9, 30, 62, 0.8)">
          ...
          <div class="modal-body d-flex align-items-center justify-content-center">
            <div class="col-md-12">
              <form action="./send_mail.php?email_origem=more.php" method="post">
                <span class="row g-3 px-2">
                  <div class="col-md-12">
                    <label for="e-mail" class="form-label">E-mail</label>
                    <input type="email" class="form-control textoemail" placeholder="Seu e-mail" name="e-mail"
                      id="e-mail" required />
                  </div>
                  <div class="col-md-12">
              ...
              <span class="row g-3 px-2">
                ...
                <div class="col-md-12">
                  <label for="email" class="form-label">E-mail * <span
                      style="font-size: 12px; margin-left: 5px;">(Somente enviamos para
