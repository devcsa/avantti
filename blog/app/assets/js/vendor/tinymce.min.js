...
!(function () {
   ...
   const Nr = (e, t, n, o) =>
      ...
      Fr = (e, t) =>
         C(t.querySelector(e)) ? (t.setAttribute(Mr, "true"), "inline-boundary" === t.getAttribute("data-mce-selected") && t.removeAttribute("data-mce-selected"), !0) : (t.removeAttribute(Mr), !1),
      Ur = (e, t) => {
   ...
   const im = (e) => "" !== e && -1 !== " \f\n\r\t\v".indexOf(e),
      ...
      Om = (e, t) => {
         if (y(e)) return null;
         {
            let n = String(e);
            return (
               ("color" !== t && "backgroundColor" !== t) || (n = $s(n)), "fontWeight" === t && 700 === e && (n = "bold"), "fontFamily" === t && (n = n.replace(/[\'\"]/g, "").replace(/,\s+/g, ",")), n
            );
         }
      },
      Bm = (e, t, n) => {
         ...
         const x = (e) => C(e) && (hr(e) || n.is(e, "figure.image")),
            ...
            S = (e) => {
               ...
               return (
                  ...
                  e !== t.getBody() &&
                  (n.hasClass(e, "mce-preview-object") && C(e.firstElementChild) ? En(Cn(e.firstElementChild), o) : En(Cn(e), o))
               );
            },
            N = (e, o, r) => {
               if (C(r)) {
   ...
   const Cp = ["font", "text-decoration", "text-emphasis"],
      ...
      ah = (e, t, n) =>
         !rh(t) &&
         (((e, t, n) => ((e, t) => ju(e.dom, t).isNone())(e, t) || ((e, t) => zu(e.dom, t).isNone())(e, t) || Vp(e, t, n) || qp(e, t, n) || Zp(e, t, n) || Xp(e, t, n))(e, t, n) ||
            nh(e, t, n) ||
            oh(e, t, n)),
      ih = (e, t, n) =>
         !rh(t) &&
               ...
               ((e, t, n, o) => {
                  ...
                  return ib(n, o).bind((o) =>
                     Tr(e.schema, o, { checkRootAsContent: !1 })
                        ? db(e, o)
                        : ((e, t, n, o, r) => Iu(n, e.getBody(), r).bind((e) => ib(t, Cn(e.getNode())).bind((e) => (_n(e, o) ? I.none() : I.some(k)))))(e, n, t, o, r)
                  );
               })(e, t, o, n).orThunk(() =>
                  Ft(
                     ((e, t) => {
         ...
         return (
            ...
            ((e, t) => {
               ...
               return (
                  C(t) &&
                  (t.isEmpty(n) ||
                     ((e, t) => e.getBlockElements()[t.name] && ((e) => C(e.firstChild) && e.firstChild === e.lastChild)(t) && ((e) => "br" === e.name || e.value === Wo)(t.firstChild))(e, t))
               );
                  ...
                  u = (t) => {
                     ...
                     q(["underline", "line-through", "overline"], (n) => {
                        er(t) &&
                           ...
                           t.parentNode &&
                           Pm(i, t.parentNode) === n &&
                           Iv(e, { deep: !1, exact: !0, inline: "span", styles: { textDecoration: n } }, void 0, t);
                     });
                  },
                  m = (e) => {
            ...
            c = (e, t) => {
               ...
               return (
                  Uv(
                     e,
                     (e) =>
                        !(!Im(e) || (("false" !== i.getContentEditable(t) || e.ceFalseOverride) && (!C(e.collapsed) || e.collapsed === a) && i.is(t, e.selector) && !qu(t) && (d(t, e), (n = !0), 1)))
                  ),
                  n
               );
            },
      ...
      const Te = function (e) {
         ...
         Me = function (e) {
            ...
            return e instanceof d &&
               ...
               ? (K &&
                    3 === e.nodeType &&
                    ((t = e.textContent), (t = ky(t, R, " ")), (t = ky(t, A, " ")), (t = ky(t, T, " ")), e.textContent !== t && (Cy(n.removed, { element: e.cloneNode() }), (e.textContent = t))),
   ...
   const fC = (e, t, n, o, r) => {
            ...
            o.addHook("uponSanitizeAttribute", (o, r) => {
               ((e, t, n, o, r) => {
                  ...
                  (r.keepAttr = gC(t, n, o, s, a, i)),
                     r.keepAttr
                        ? ((r.allowedAttributes[a] = !0), hC(a, n) && (r.attrValue = a), t.allow_svg_data_urls && $e(i, "data:image/svg+xml") && (r.forceKeepAttr = !0))
                        ...
                        e.replace(
                           (({ type: e, src: t, width: n, height: o } = {}, r, s) => {
                              const a = ((e) => (v(e) ? "iframe" : iy(e, "image") ? "img" : iy(e, "video") ? "video" : iy(e, "audio") ? "audio" : "iframe"))(e),
                                 i = new Jg(a, 1);
                              return (
                                 i.attr("audio" === a ? { src: t } : { src: t, width: n, height: o }), ("audio" !== a && "video" !== a) || i.attr("controls", ""), "iframe" === a && r && ay(i, s), i
                              );
      ...
      GC = (e, t, n) => {
         ...
         "fragmented" === t.type ? WC(t.fragments, e.getBody()) : e.setContent(t.content, { format: "raw", no_selection: !C(o) || !Yu(o) || !o.isFakeCaret }),
         ...
         undoManager: {
            ...
            undo: (t, n, o) =>
               ((e, t, n, o) => {
                  let r;
                  return (
                     t.typing && (t.add(), (t.typing = !1), ew(t, !1, n)), o.get() > 0 && (o.set(o.get() - 1), (r = t.data[o.get()]), GC(e, r, !0), e.setDirty(!0), e.dispatch("Undo", { level: r })), r
                  );
               })(e, t, n, o),
            redo: (t, n) =>
               ((e, t, n) => {
      ...
      cx = (e, t) => {
         ...
         return (
            sx(o.split(" "), (e) => {
               ...
               if (
                  !(
                     ("background-color" === e && /transparent|rgba\s*\([^)]+,\s*0\)/.test(t) && ((t = s(e)), "#ffffff" === $s(t).toLowerCase())) ||
   ...
   const WE = (e, t, n, o, r, s) => {
      ...
      M_ = (e, t) => {
         ...
         return ((e, t) => ((e, t, n = L) => (n(t) ? I.none() : H(e, $t(t)) ? I.some(t) : to(t, e.join(","), (e) => En(e, "table") || n(e))))(["td", "th"], e, t))(
   ...
   const Z_ = (e, t, n) => (e.stype === X_.Error ? t(e.serror) : n(e.svalue)),
      ...
      pS = (e, t, n) => {
         return (
            (o = ((e, t, n) => ((e, t) => (e.stype === X_.Error ? { stype: X_.Error, serror: t(e.serror) } : e))(t.extract([e], n), (e) => ({ input: n, errors: e })))(e, t, n)),
            ...
            if (p)
               ...
               ((e) => {
                  ...
                  ((e, t, n) => {
                     ...
                     let a = r.length;
                     for (; a--; )
                        (s = r[a]), (!s.hasChildNodes() || (s.firstChild === s.lastChild && "" === (null === (o = s.firstChild) || void 0 === o ? void 0 : o.nodeValue)) || DN(e, s)) && e.remove(s);
                  })(i, l, R),
                  ((e, t) => {
                     t.normalize();
                     const n = t.lastChild;
      ...
      hO = (e, t) => {
         ...
         return /^ | $/.test(t)
            ? ((e, t, n, o) => {
                 ...
                 return (
                    (n = ih(r, Qi.fromRangeStart(t), o) ? n.replace(/^ /, "&nbsp;") : n.replace(/^&nbsp;/, " ")),
            ...
            ((e) => {
               ...
               t("id", { processor: "string", default: e.id }),
                  ...
                  t("noneditable_regexp", {
                     processor: (e) => (E(e, Dl) ? { value: e, valid: !0 } : Dl(e) ? { value: [e], valid: !0 } : { valid: !1, message: "Must be a RegExp or an array of RegExp." }),
                     default: [],
                  }),
         ...
         remove(e) {
            ...
            if (e) {
               if (!m(e))
                  return (
                     (n = e),
                     h(t.get(n.id)) ? null : (vB(n) && t.dispatch("RemoveEditor", { editor: n }), 0 === pB.length && window.removeEventListener("beforeunload", fB), n.remove(), bB(pB.length > 0), n)
                  );
               mB(uB.select(e), (e) => {
