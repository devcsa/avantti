...
<head>
  ...
  <title>Caixa de Ferramentas - Etapa 2 - Capturando informações - Avantt.i</title>
      ...
      <div class='container-fluid bg-primary py-3 bg-blog-post'>
        <div class='row py-4'>
          <div class='titulo-mobile mt-6 pt-3 title-blog'>
            <h1 class='main-title animated zoomIn mb-4'>Caixa de Ferramentas - Etapa 2 - Capturando informações</h1>
      ...
      <div class='row g-5'>
        <div class='col-lg-8'>
          <div class='img-destaque position-relative overflow-hidden'>
            <img class='img-fluid' src='../app/assets/img/posts/destaques/8_02_Banner.png' alt='Imagem Destaque' />
          </div>
...
<h2>Etapa 2</h2>
<p><img src="app/assets/img/posts/basepath/mceu_25845198811718135694260.png"></p>
<p>Nesta segunda etapa abordamos o Planejamento da Entrevista e o Desk Research Frame.<br><br><a href="https://materiais.avanttinovacao.com.br/ebook-caixa-de-ferramentas-etapa-2">Acesse agora nosso eBook e fa&ccedil;a parte da inova&ccedil;&atilde;o!</a></p>
          </div>
        </div>
