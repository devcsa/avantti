...
<head>
  ...
  <meta name="description"
    content="Acesse o Blog da Avantti e fique por dentro das tendências, insights e dicas sobre gestão da inovação. Transforme ideias em projetos inovadores para sua empresa.">
  <meta name="keywords"
    content="Blog sobre gestão da inovação, Dicas de inovação empresarial, Insights para inovação corporativa, Tendências em gestão de inovação, Conteúdos sobre inovação organizacional">
    ...
    <div class="form-container">
      <div id="login-form" class="auth-form active">
        <div class="logo-login">
          <a href="https://www.avanttinovacao.com.br" target="_blank"><img src="./app/assets/img/logos/logo-clara.png"
        ...
        <form action="./app/Models/login.php" method="post">
          <div class="form-group">
            ...
            <input type="email" name="email-login" placeholder="E-mail" id="email-login" aria-label="Email address"
              required />
