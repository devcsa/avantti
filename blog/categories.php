...
<body>
  ...
  <!-- Header -->
  <header id="main-header" class="main-header py-2 bg-success text-white">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <h1><i class="fa fa-folder" aria-hidden="true"></i> Categorias</h1>
        </div>
      </div>
    </div>
  </header>
      ...
      <div class="container">
        <div class="row">
          <div class="col">
            ...
            <?php
            include "./app/Models/categories/categoryModel.php";
            ?>
            <!-- <nav class="ml-4 mt-5">
            <ul class="pagination">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form id="editCategoryForm" action="./app/Models/categories/EditCategory.php/?" method="POST">
              <div class="form-group">
                <label for="name-category">Categoria</label>
                <input type="text" class="form-control" value="" name="name-category" id="name-category" />
              ...
              <div class="modal-footer mt-4">
                ...
                <button type="submit" id="editCategoryButton" class="btn btn-success">Salvar</button>
              </div>
            </form>
          </div>
        </div>
