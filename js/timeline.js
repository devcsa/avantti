...
// console.log("Content Width: ", estilo.width);
// console.log("Content Height:", estilo.Height);

var timeline = document.querySelector(".timeline");
var estilotimeline = window.getComputedStyle(timeline);
// console.log("Timeline Widtg: ", estilotimeline.width);
// console.log("Timeline Height:", estilotimeline.Height);
