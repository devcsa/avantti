...
<body>
      ...
      <div class="container-fluid bg-primary py-5 bg-header">
        <div class="row py-5">
          <div class="col-12 pt-lg-5 mt-lg-5 text-center">
            <h6 class="display-4 text-white animated zoomIn text-uppercase mb-4">Sobre <span
                class="text-primary">Nós</span></h6>
            <p id="pricing" class="h5 text-white">Conheça mais sobre a nossa história e nosso propósito</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- Institucional Start -->
  <div class="bg-light shadow d-flex align-items-center justify-content-center p-4 mb-6">
    <p class="text-center timeline-sobre">
      Construímos nossa plataforma com auxílio de desenvolvedores parceiros <br />e a partir de 2022 internalizamos
      nosso desenvolvimento.<br /><br />
      Adquirimos nossos primeiros clientes em 2023 e, como um novo negócio, estamos <br />crescendo na nossa equipe para
      atender com excelência nossos clientes.<br /><br />
      Tecnologia, inovação e estratégia, são alguns dos pilares que a Avantt.i reúne.<br /><br />
      Nossa missão é fazer com que o seu negócio gere resultados <br />a partir da gestão da inovação e da experiência
      da
      Inventta.
    </p>
  </div>
  ...
  <section id="about" class="about mb-5">
    <div class="d-flex flex-column justify-content-center pt-4">
      <div class="section-title text-center position-relative pb-1 mb-5 mx-auto" style="max-width: 600px">
        <h4 class="fw-bold text-primary">Nossa história</h4>
      </div>
      ...
      <div class="content">
        <div class="timeline">
          ...
          <div class="timeline__elem timeline__elem--left">
            <div class="timeline__date"><span class="timeline__date-day">2002</span></div>

            <div class="timeline__event">
              <div class="timeline__event-date-time">
                <div class="timeline__event-date"><span>2002</span></div>
              </div>

              <h4 class="timeline__event-title">Inventta</h4>

              <div class="timeline__event-descr">
                <p>Surge a <strong>Inventta</strong>, um projeto dentro do <strong>Grupo Instituto Inovação</strong>.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="timeline__elem timeline__elem--right">
            <div class="timeline__date"><span class="timeline__date-day">2005</span></div>

            <div class="timeline__event">
              <div class="timeline__event-date-time">
                <div class="timeline__event-date"><span>2005</span></div>
              </div>

              <h4 class="timeline__event-title">Nova Liderança</h4>

              <div class="timeline__event-descr">
                <p><strong>Bruno Moreira</strong> torna-se CEO da Inventta</p>
              </div>
            </div>
          </div>

          <div class="timeline__elem timeline__elem--left">
            <div class="timeline__date"><span class="timeline__date-day">2008</span></div>

            <div class="timeline__event">
              <div class="timeline__event-date-time">
                <div class="timeline__event-date"><span>2008</span></div>
              </div>

              <h4 class="timeline__event-title">Expansão Inventta</h4>

              <div class="timeline__event-descr">
                <p>Expandimos a operação para a <strong>Colômbia</strong></p>
              </div>
            </div>
          </div>

          <div class="timeline__elem timeline__elem--right">
            <div class="timeline__date"><span class="timeline__date-day">2020</span></div>

            <div class="timeline__event">
              <div class="timeline__event-date-time">
                <div class="timeline__event-date"><span>2020</span></div>
              </div>

              <h4 class="timeline__event-title">Nascimento Avantt.i</h4>

              <div class="timeline__event-descr">
                <p>Através do estudo das dores e do feedback dos Clientes, surge o <strong>Avantt.i</strong> e nesse
                  mesmo
                  ano o <strong>Inventta Academy</strong>.</p>
              </div>
            </div>
          </div>

          <div class="timeline__elem timeline__elem--left">
            <div class="timeline__date"><span class="timeline__date-day">2023</span></div>

            <div class="timeline__event">
              <div class="timeline__event-date-time">
                <div class="timeline__event-date"><span>2023</span></div>
              </div>

              <h4 class="timeline__event-title">Novos Horizontes</h4>

              <div class="timeline__event-descr">
                <p>Crescimento da Equipe <strong>Inventta</strong> e <strong>Avantt.i</strong></p>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content" style="background: rgba(9, 30, 62, 0.8)">
        ...
        <div class="modal-body d-flex align-items-center justify-content-center">
          <div class="col-md-12">
            <form action="./send_mail.php?email_origem=about.php" method="post">
